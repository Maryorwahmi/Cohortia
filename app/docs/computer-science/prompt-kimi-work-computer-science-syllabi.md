...
> **Goal:** Create detailed, chapter-level syllabi for every Computer Science course in the Cohortia catalog so that the platform can generate slides, audio, video, quizzes, hands-on labs, and coding exercises automatically.
...
**Current progress:** We are generating syllabi for all 13 Computer Science subcategories, one subcategory at a time, in this recommended order:

1. Programming & Software Development Fundamentals — ✅ Done
2. Web Development — ✅ Done
3. Mobile App Development — Not started
4. Computer Networks — Not started
5. Databases — Not started
6. Operating Systems & System Administration — Not started
7. Software Engineering, Architecture & Design — Not started
8. Data Science, Machine Learning & AI — Not started
9. Cybersecurity — Not started
10. Cloud Computing & DevOps — Not started
11. Game Development — Not started
12. Blockchain & Web3 — Not started
13. Hardware, Embedded & IoT — ✅ Done
...
1. **Use the exact course metadata.** The generator provides the real course title, provider, platform, level, type, duration, skills, and subcategory. Every module and chapter must be shaped by these facts. A course titled "Google Cybersecurity Professional Certificate" must cover Google's actual cybersecurity curriculum topics (e.g., SIEM, Python for security, Linux, incident response), not a vague "Introduction to Cybersecurity."
...
4. **Specific tools and technologies only.** Name the actual tools, languages, frameworks, platforms, and commands used by the course. Examples: `nmap`, `Wireshark`, `Splunk`, `Docker`, `Kubernetes`, `TensorFlow`, `SwiftUI`, `Kotlin`, `SQL`, `Metasploit`, `AWS EC2`, `React Router`, `Vite`.
...
docs/computer-science/intermediate/mobile-app-development/introduction-to-ios-development.md
```
...
| 8 | Databases | 21 |
| 9 | Operating Systems & System Administration | 21 |
| 10 | Software Engineering, Architecture & Design | 17 |
| 11 | Game Development | 19 |
| 12 | Blockchain & Web3 | 17 |
| 13 | Hardware, Embedded & IoT | 11 |
...
- **Real code examples.** Include actual code snippets in the correct language, framework, or technology stack for the course (HTML/CSS/JS, Python, SQL, C, Java, React, Docker, etc.).
