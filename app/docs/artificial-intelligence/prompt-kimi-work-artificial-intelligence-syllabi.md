# Copilot Work Prompt — Generate Cohortia Artificial Intelligence Syllabi

> **Use this entire document as the prompt in Copilot Work.**  
> **Goal:** Create detailed, chapter-level syllabi for every Artificial Intelligence course in the Cohortia catalog so that the platform can generate slides, audio, video, quizzes, hands-on labs, and coding exercises automatically.
...
- `docs/catalog-artificial-intelligence.md` — first curated catalog (300 courses/certificates)
- `docs/catalog-artificial-intelligence-research.md` — expanded research draft
- `docs/artificial-intelligence/catalog-courses-by-subcategory.json` — **source of truth**: 300 distinct Artificial Intelligence courses grouped into 12 subcategories
...
**Current progress:** We are generating syllabi for all 12 Artificial Intelligence subcategories, one subcategory at a time, in this recommended order:

1. AI Fundamentals & Principles — Not started
2. Machine Learning Engineering — Not started
3. Deep Learning & Neural Networks — Not started
4. Natural Language Processing & LLMs — Not started
5. Computer Vision & Multimodal AI — Not started
6. Generative AI & Foundation Models — Not started
7. Robotics & Autonomous Systems — Not started
8. Reinforcement Learning & Game AI — Not started
9. AI Ethics, Safety & Governance — Not started
10. AI for Science & Research — Not started
11. Edge AI & AI Hardware — Not started
12. AI Strategy, Product & Business — Not started

**Total: 300 courses.** The long-term goal is a full syllabus for every course.
...
Do not write chapter headings with only bullet lists. Write full explanations, definitions, code examples, commands, configuration steps, practical activities, common mistakes, and safety notes that match the specific course topic.

### Anti-Generic Rules — APPLY TO EVERY COURSE

1. **Use the exact course metadata.** The generator provides the real course title, provider, platform, level, type, duration, skills, and subcategory. Every module and chapter must be shaped by these facts. A course titled "Deep Learning Specialization" must cover the actual deep learning curriculum topics (e.g., CNNs, RNNs, Transformers, optimization), not a vague "Introduction to Deep Learning."
...
4. **Specific tools and technologies only.** Name the actual tools, languages, frameworks, platforms, and commands used by the course. Examples: `TensorFlow`, `PyTorch`, `Keras`, `Hugging Face Transformers`, `OpenCV`, `ROS`, `LangChain`, `MLflow`, `Kubeflow`, `Spark MLlib`, `JAX`, `ONNX`, `NVIDIA TensorRT`, `Stable Diffusion`, `YOLO`, `BERT`, `GPT`, `CLIP`, `Gradio`, `Streamlit`, `Weights & Biases`.

5. **Concrete scenarios, not abstract definitions.** Every hands-on activity and assessment must be a realistic task a learner in that course would actually do, with specific commands, code, or configuration.
...
```
docs/artificial-intelligence/catalog-courses-by-subcategory.json
```

Place each syllabus under the folder path:

```
docs/artificial-intelligence/{level}/{subcategory-slug}/{course-id}.md
```

For example:

```
docs/artificial-intelligence/beginner/ai-fundamentals-principles/ai-for-everyone.md
docs/artificial-intelligence/intermediate/deep-learning-neural-networks/deep-learning-specialization.md
```
...
- `AI Fundamentals & Principles` → `ai-fundamentals-principles/`
...
- `Computer Vision & Multimodal AI` → `computer-vision-multimodal-ai/`
- `Generative AI & Foundation Models` → `generative-ai-foundation-models/`
- `Robotics & Autonomous Systems` → `robotics-autonomous-systems/`
- `Reinforcement Learning & Game AI` → `reinforcement-learning-game-ai/`
- `AI Ethics, Safety & Governance` → `ai-ethics-safety-governance/`
- `AI for Science & Research` → `ai-for-science-research/`
- `Edge AI & AI Hardware` → `edge-ai-ai-hardware/`
- `AI Strategy, Product & Business` → `ai-strategy-product-business/`
...
From `docs/artificial-intelligence/catalog-courses-by-subcategory.json`:

| # | Subcategory | Courses |
|---|-------------|---------|
| 1 | AI Fundamentals & Principles | 20 |
| 2 | Machine Learning Engineering | 20 |
| 3 | Deep Learning & Neural Networks | 20 |
| 4 | Natural Language Processing & LLMs | 30 |
| 5 | Computer Vision & Multimodal AI | 30 |
| 6 | Generative AI & Foundation Models | 30 |
| 7 | Robotics & Autonomous Systems | 25 |
| 8 | Reinforcement Learning & Game AI | 25 |
| 9 | AI Ethics, Safety & Governance | 25 |
| 10 | AI for Science & Research | 25 |
| 11 | Edge AI & AI Hardware | 25 |
| 12 | AI Strategy, Product & Business | 25 |
...
- `docs/artificial-intelligence/beginner/ai-fundamentals-principles/`
- `docs/artificial-intelligence/intermediate/natural-language-processing-llms/`
- `docs/artificial-intelligence/advanced/robotics-autonomous-systems/`
...
- **Real code examples.** Include actual code snippets in the correct language, framework, or technology stack for the course (Python, PyTorch, TensorFlow, JAX, SQL, R, MATLAB, etc.).
- **Real commands and tools.** Include real terminal commands, package manager commands, framework CLI commands, deployment commands, and tool names relevant to the subject.
- **Common mistakes and safety notes.** Tell learners what can go wrong and how to avoid it.
...
- **Tone:** beginner-friendly, encouraging, concise, professional, hands-on, safety-conscious.
- **Visual style:** live coding, terminal demos, Jupyter notebook views, diagram overlays, side-by-side code/output, network architecture diagrams, data flow diagrams, model visualization, confusion matrices, loss curves, attention heatmaps.
...
**Example for a PyTorch chapter:**

```markdown
#### AI generation note
Create a 10-minute live coding video. Start with an empty conda environment, install PyTorch with CUDA support, build a simple feedforward network for MNIST classification, and show training loss curves updating in real time using Weights & Biases. Include a split-screen view of code on the left and TensorBoard on the right. End with a 2-question interactive mini-quiz about backpropagation and gradient flow.
```
...
1. **Start with the source catalog entry** — read the title, provider, platform, level, and skills from `docs/artificial-intelligence/catalog-courses-by-subcategory.json`.
...
3. Look for:
   ...
   - Required tools, languages, frameworks, hardware, or software
...
- **File path:** `docs/artificial-intelligence/{level}/{subcategory-slug}/{course-id}.md`
- Use lowercase kebab-case for course IDs and folder names.
- Do **not** use spaces in file names.
- Do **not** modify files outside `docs/artificial-intelligence/`.
